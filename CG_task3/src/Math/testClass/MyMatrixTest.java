...
class MyMatrixTest {
    ...
    void transposeMatrix() {
        ...
        matrixT[2] = thirdT;
        MyMatrix3 answer = new MyMatrix3(matrix);
        assertEquals(answer.transposeMatrix().getMatrixArray()[0][0], matrixT[0][0]);
        assertEquals(answer.transposeMatrix().getMatrixArray()[0][1], matrixT[0][1]);
        assertEquals(answer.transposeMatrix().getMatrixArray()[0][2], matrixT[0][2]);
        assertEquals(answer.transposeMatrix().getMatrixArray()[1][0], matrixT[1][0]);
        assertEquals(answer.transposeMatrix().getMatrixArray()[1][1], matrixT[1][1]);
        assertEquals(answer.transposeMatrix().getMatrixArray()[1][2], matrixT[1][2]);
        assertEquals(answer.transposeMatrix().getMatrixArray()[2][0], matrixT[2][0]);
        assertEquals(answer.transposeMatrix().getMatrixArray()[2][1], matrixT[2][1]);
        assertEquals(answer.transposeMatrix().getMatrixArray()[2][2], matrixT[2][2]);
    }
    ...
    void getZeroMatrix() {
        ...
        matrix[2] = third;
        matrix[3] = fourth;
        MyMatrix answer = MyMatrix.getZeroMatrix(4);
        assertEquals(answer.getMatrixArray()[0][0], matrix[0][0]);
        assertEquals(answer.getMatrixArray()[0][1], matrix[0][1]);
        assertEquals(answer.getMatrixArray()[0][2], matrix[0][2]);
    ...
    void getOneMatrix() {
        ...
        matrix[2] = third;
        matrix[3] = fourth;
        MyMatrix answer = MyMatrix.getOneMatrix(4);
        assertEquals(answer.getMatrixArray()[0][0], matrix[0][0]);
        assertEquals(answer.getMatrixArray()[0][1], matrix[0][1]);
        assertEquals(answer.getMatrixArray()[0][2], matrix[0][2]);
        assertEquals(answer.getMatrixArray()[0][3], matrix[0][3]);
